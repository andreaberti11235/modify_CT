...
dose_profiles = glob.glob('/Users/andreaberti/Desktop/tesi/nifti_simulated/median_2/median_2_RAI/test_patient_*.nii.gz')
...
if dw:
  ctv_low_dose = nib.load('/Users/andreaberti/Desktop/tesi/pet_original_patient/ctv_low_dw_for_pet.nii.gz')
else:
...
for modified_PET in glob.glob(mpet_dir+'/*'):
    ...
    p_values_negatives_reverse[first_pet.get_fdata()<threshold] = 0
