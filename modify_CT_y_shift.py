...
def shift_mask(mask, dy, ord=3):
    """Shifts the mask in y direction. Returns the shifted mask as a Numpy array.
    Arguments:
    "mask"      Numpy array
...
if __name__ == "__main__":
    ...
    parse.add_argument('dicom_dir', help='Directory of the original DICOM files')
    parse.add_argument('mask_mat', help='Path to the mask in MATLAB format')
    parse.add_argument('out_path', help='Path to the output directory')
