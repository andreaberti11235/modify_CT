...
for modified_PET in glob.glob(mpet_dir+'/*'):
    ...
    # create a nib object importing a PET to get the header
    y = nib.load('/Users/andreaberti/Desktop/tesi/nifti_simulated/shift_x_1.nii.gz')

    # save the p-maps
    x_r_pos = nib.Nifti1Image(p_values_positives_reverse, y.affine, header=y.header)
    x_r_pos.to_filename('/Users/andreaberti/Desktop/tesi/p_values/p_values_threshold/100_images/PET_no_filter/{}_rev_positive_no_filter.nii'.format(name))
    x_r_neg = nib.Nifti1Image(p_values_negatives_reverse, y.affine, header=y.header)
    x_r_neg.to_filename('/Users/andreaberti/Desktop/tesi/p_values/p_values_threshold/100_images/PET_no_filter/{}_rev_negative_no_filter.nii'.format(name))